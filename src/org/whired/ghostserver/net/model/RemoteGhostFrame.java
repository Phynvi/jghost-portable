...
public class RemoteGhostFrame extends GhostFrame {
	...
	public void displayPublicChat(Player sender, String message) {
		getConnection().sendPacket(PacketType.INVOKE_ACCESSOR, Accessor.getClass("org.whired.ghostclient.Main").getField("instance").getMethod("getFrame").getMethod("displayPublicChat", sender, message));
	}
	...
	public void displayDebug(Level level, String message) {
		getConnection().sendPacket(PacketType.INVOKE_ACCESSOR, Accessor.getClass("org.whired.ghostclient.Main").getField("instance").getMethod("getFrame").getMethod("displayDebug", level, message));
	}
}
