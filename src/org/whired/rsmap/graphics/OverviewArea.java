...
public class OverviewArea {
	...
	public OverviewArea(final RSCanvas canvas, final int width, final int height) {
	...
	private void drawArea(int i, int j, int k, final int l, final int i1, final int j1) {
		final int k1 = -(k >> 2);
		k = -(k & 3);
