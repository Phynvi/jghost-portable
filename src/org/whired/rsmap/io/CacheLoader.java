...
public class CacheLoader {
	...
	public CacheLoader(final byte abyte0[]) {
		method75(abyte0);
	}

	public void method75(final byte abyte0[]) {
		ByteBuffer class1_sub1_sub2 = new ByteBuffer(abyte0);
		final int i = class1_sub1_sub2.getShortInt();
		final int j = class1_sub1_sub2.getShortInt();
		if (j != i) {
