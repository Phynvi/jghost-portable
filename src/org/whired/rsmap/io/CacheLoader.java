...
public class CacheLoader
{
	...
	public void method75(byte abyte0[])
	{
		...
		for (int l = 0; l < nodesLoaded; l++)
		{
			...
			k += anIntArray97[l];
			//System.out.println("95: "+anIntArray95[l]+" | 96: "+anIntArray96[l]+" | 97: "+anIntArray97[l]+" | 98: "+anIntArray98[l]+" | k: "+k);
		}
	}
	...
	public byte[] loadNode(String nodeName)
	{
		...
		System.out.println("load node: " + nodeName + " | Hash: " + i + " | aBoolean99: "+aBoolean99);
