...
public interface PlayerListEventListener {
	...
	/**
	 * Invoked when the currently selected player changes
	 * @param oldPlayer the player that was previously selected, or {@code null}
	 * if no player was selected
	 * @param newPlayer the player that is currently selected
	 */
