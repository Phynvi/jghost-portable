...
public class JRoundedButton extends JButton {
	 ...
	 */
	public JRoundedButton(final String text, final int preferredWidth, final int preferredHeight) {
		super(text);
	 ...
	 * @param text the text to display on the rounded button
	 */
	public JRoundedButton(final String text) {
		super(text);
		setBorderPainted(false);
	}
	 ...
	 */
	public JRoundedButton(final String text, final Icon icon) {
		super(text, icon);
		setBorderPainted(false);
	}
	 ...
	 */
	public JRoundedButton(final Action a) {
		super(a);
		setBorderPainted(false);
	}
	 ...
	 */
	public JRoundedButton(final Icon icon) {
		super(icon);
		setBorderPainted(false);
	}
	...
	protected void paintComponent(final Graphics g) {
		...
		final Shape firstClip = g.getClip();
		...
		final Area secondClip = new Area(getBounds());
		secondClip.subtract(new Area(rect));
		final Area finalClip = new Area(firstClip);
